...
ConfirmationCode.createOrUpdateFromNumber = async function(phoneNumber) {
  ...
  if (confirmation.codesCreated >= MAX_CODES_CREATED) {
    throw new PermissionsError(
      "You have created the maximum number of confirmation codes"
    );
  } else {
...
ConfirmationCode.attemptValidationWhere = async function(data) {
